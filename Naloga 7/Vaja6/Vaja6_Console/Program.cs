...
var response2 = client.UpdateVoznik(new UpdateVoznikRequest { Id = 14, Ime = "Lewis", Priimek = "Hamilton", Starost = 40, Stevilkaformule = 2, Stevilozmag = 100 });


//implementiraj za delete
var response3 = client.DeleteVoznik(new DeleteVoznikRequest { Id = 13 });
